  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="heroShiny1 text-fun-pink"><b>First Plate</b></span>
        </h1>
        ...
        <img
          ...
          <div className="flex flex-row justify-between">
            <div className="w-fit mx-auto mt-5 cursor-pointer font-bold whitespace-nowrap px-10 py-4 text-fun-white text-xl rounded-full  bg-bg hover:bg-fun-pink hover:text-white hover:border-fun-pink transition-colors">
              <a href="https://www.figma.com/file/i0UC3XiEdv6rRn8Q0aHXlt/First-Plate?type=design&node-id=0%3A1&mode=design&t=QWuDKmT8Q85aj1Zk-1">figma ↗</a>
            </div>
            <div className="w-fit mx-auto mt-5 cursor-pointer font-bold whitespace-nowrap px-10 py-4 text-fun-white text-xl rounded-full  bg-bg hover:bg-fun-pink hover:text-white hover:border-fun-pink transition-colors">
              <a href="https://devpost.com/software/first-plate">devpost ↗</a>
            </div>
          </div>
      </div>
      ...
      <img
            ...
            src="/static/projects/userflow-fp.png"
          />
      ...
      >
        <h1 className="text-white text-4xl sm:text-3xl inline-block w-auto mx-auto relative">
         <b><span className="heroShiny1 text-fun-pink">🎨 Logo, Design & Style Guide, & Wireframe</span></b>
        </h1>
      </div>
      <img
            className="w-11/12 rounded-3xl mx-auto mt-6"
            src="/static/projects/first-plate-wireframe.png"
          />
      ...
      >
        <h1 className="text-white text-4xl sm:text-3xl inline-block w-auto mx-auto relative">
         <b><span className="heroShiny1 text-fun-pink">⚒️ App Features</span></b>
        </h1>
      </div>
      <img
        className="w-11/12 rounded-3xl mx-auto mt-6"
        src="/static/projects/firstplate-frames/2.png"
      />
        <img
          className="w-11/12 rounded-3xl mx-auto mt-6"
          src="/static/projects/firstplate-frames/3.png"
        />
        <img
        className="w-11/12 rounded-3xl mx-auto mt-6"
        src="/static/projects/firstplate-frames/4.png"
      />
      <img
        className="w-11/12 rounded-3xl mx-auto mt-6"
        src="/static/projects/firstplate-frames/5.png"
      />
      <img
        className="w-11/12 rounded-3xl mx-auto mt-6"
        src="/static/projects/firstplate-frames/6.png"
      />
