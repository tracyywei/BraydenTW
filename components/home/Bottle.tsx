  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="heroShiny1 text-fun-pink"><b>Bottle (work in progress)</b></span>
        </h1>
        <p className="text-black text-xl sm:text-2xl max-w-3xl m-auto">
        A social app for long-distance loved ones
        </p>
        ...
        <img
            ...
            src="/static/projects/bottle details.png"
          />
          <div className="flex flex-row justify-between">
            <div className="w-fit mx-auto mt-5 cursor-pointer font-bold whitespace-nowrap px-10 py-4 text-fun-white text-xl rounded-full  bg-bg hover:bg-fun-pink hover:text-white hover:border-fun-pink transition-colors">
              <a href="http://www.figma.com/file/fP6KPZ9OSvW9cTzTupWplI/Task-Flows?type=design&node-id=0%3A1&mode=design&t=BuZdWUGWYBg5GY41-1">figma ↗</a>
            </div>
            <div className="w-fit mx-auto mt-5 cursor-pointer font-bold whitespace-nowrap px-10 py-4 text-fun-white text-xl rounded-full  bg-bg hover:bg-fun-pink hover:text-white hover:border-fun-pink transition-colors">
              <a href="https://web.stanford.edu/class/cs147/projects/PreservingthePast/Bottle/">website with updated details ↗</a>
            </div>
          </div>
      </div>
      ...
      <div
        className="pt-10 pb-4 sm:pt-10 sm:pb-10 w-10/12 text-center relative bg-white rounded-3xl mt-20 mx-auto"
      >
        <h1 className="text-white text-4xl sm:text-3xl inline-block w-auto mx-auto mb-8 relative">
      ...
      <img
            ...
            src="/static/projects/bottle-interviews.png"
          />
      ...
      >
        ...
        <div className="flex flex-row justify-center">
          <p className="text-black text-lg sm:text-xl max-w-3xl mr-8 text-left">
            ...
            <br/> <span className="text-2xl"><br></br><b>Need:</b></span>
            <br/> People in long-distance relationships want to express their joys and sorrows in real time.
          </p>
        </div>
      </div>
      <img
            className="w-11/12 rounded-3xl mx-auto mt-6"
            src="/static/projects/bottle-empathymap.png"
          />
          <img
            className="w-11/12 rounded-3xl mx-auto mt-6"
            src="/static/projects/bottle-findings.png"
          />

      <div
        className="pt-1 pb-1 sm:pt-10 sm:pb-10 w-10/12 text-center relative bg-white rounded-3xl mt-20 mx-auto"
      >
        <h1 className="text-white text-4xl sm:text-3xl inline-block w-auto mx-auto relative">
         <b><span className="heroShiny1 text-fun-pink">🎨 High-Fidelty Prototype</span></b>
        </h1>
        <div className="w-fit mx-auto mt-5 cursor-pointer font-bold whitespace-nowrap px-10 py-4 text-fun-white text-xl rounded-full  bg-bg hover:bg-fun-pink hover:text-white hover:border-fun-pink transition-colors">
              <a href="http://www.figma.com/file/fP6KPZ9OSvW9cTzTupWplI/Task-Flows?type=design&node-id=0%3A1&mode=design&t=BuZdWUGWYBg5GY41-1">figma ↗</a>
            </div>
      ...
      <img
            className="w-11/12 rounded-3xl mx-auto mt-6"
            src="/static/projects/bottle-wireframe.png"
          />
      ...
      >
        ...
        <div className="w-fit mx-auto mt-5 cursor-pointer font-bold whitespace-nowrap px-10 py-4 text-fun-white text-xl rounded-full  bg-bg hover:bg-fun-pink hover:text-white hover:border-fun-pink transition-colors">
              <a href="https://web.stanford.edu/class/cs147/projects/PreservingthePast/Bottle/">website with details ↗</a>
            </div>
      </div>
